            ...
            {DEMO_MODE ? (
              <div className="mt-5 rounded-lg border border-primary/30 bg-primary/[0.06] p-3 text-sm">
                ...
                <button
                  type="button"
                  onClick={() => {
                    setEmail(DEMO_CLIENTE.email)
                    setSenha(DEMO_CLIENTE.senha)
                  }}
                  className="mt-2 text-foreground hover:text-primary"
                >
                  <span className="font-medium">{DEMO_CLIENTE.label}:</span> {DEMO_CLIENTE.email}
                </button>
                <p className="mt-2 text-xs text-muted-foreground">Senha: {DEMO_CLIENTE.senha}</p>
              </div>
            ) : (
